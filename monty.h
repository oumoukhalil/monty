...
int void_line(char *line, char *delims);
int execute(char **token, stack_t **stack, unsigned int line_num);
int stack_push(stack_t **stack, char **token, unsigned int line_num);
int queue_push(stack_t **stack, char **token, unsigned int line_num);
...
int opening_error(char *filename);
